...
export const DEFAULT_USERS: User[] = [
  {
    ...
    description: 'Leisure traveler • BeeMiles Member • Main Cabin',
    properties: {
      booleans: {
  ...
  },
  {
    ...
    description: 'Corporate traveler • Gold BeeMiles • HiveAir Lounge access',
    properties: {
      booleans: {
  ...
  },
  {
    ...
    description: 'Diamond BeeMiles • First Class • HiveAir Lounge Ambassador',
    properties: {
      booleans: {
        hasLoungeAccess: true,
        isPremiumMember: true,
  ...
  },
  {
    id: 'beta-tester',
    name: 'Drew Beta',
    email: 'drew.beta@example.com',
    description: 'Beta tester • Silver BeeMiles • Testing new features',
    properties: {
      booleans: {
        hasLoungeAccess: false,
        isPremiumMember: false,
  ...
  },
  {
    id: 'airline-staff',
    name: 'Alex Staff',
    email: 'alex.staff@hiveair.com',
    description: 'HiveAir employee • Staff travel benefits • HiveAir Lounge access',
    properties: {
      booleans: {
        hasLoungeAccess: true,
        isPremiumMember: false,
